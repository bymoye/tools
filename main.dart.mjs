...
_1638: f => finalizeWrapper(f,x0 => dartInstance.exports._1638(f,x0)),
...
_1712: () => Date.now(),
_1737: x0 => x0.getReader(),
_1741: (x0,x1) => x0.cancel(x1),
_1742: x0 => x0.read(),
_1745: x0 => x0.value,
_1747: x0 => x0.done,
_1750: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11) => ({method: x0,headers: x1,body: x2,mode: x3,credentials: x4,cache: x5,redirect: x6,referrer: x7,referrerPolicy: x8,integrity: x9,keepalive: x10,signal: x11}),
_1752: (x0,x1) => x0.method = x1,
_1765: (x0,x1) => x0.redirect = x1,
_1778: (x0,x1) => globalThis.fetch(x0,x1),
_1779: () => new AbortController(),
_1780: x0 => x0.abort(),
_1781: (x0,x1) => x0.get(x1),
_1782: (x0,x1) => x0.get(x1),
_1783: (x0,x1) => x0.get(x1),
_1807: x0 => new Headers(x0),
_1810: x0 => x0.entries(),
_1829: x0 => x0.body,
_1831: x0 => x0.headers,
_1833: x0 => x0.redirected,
_1834: x0 => x0.status,
_1835: x0 => x0.statusText,
_1836: x0 => x0.type,
_1837: x0 => x0.url,
_1851: () => new XMLHttpRequest(),
_1852: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1853: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1854: (x0,x1) => x0.send(x1),
_1856: x0 => x0.getAllResponseHeaders(),
_1863: f => finalizeWrapper(f,x0 => dartInstance.exports._1863(f,x0)),
_1864: f => finalizeWrapper(f,x0 => dartInstance.exports._1864(f,x0)),
_1879: x0 => x0.signal,
_1893: (a, i) => a.push(i),
_1897: a => a.pop(),
_1898: (a, i) => a.splice(i, 1),
_1900: (a, s) => a.join(s),
_1904: a => a.length,
_1906: (a, i) => a[i],
_1907: (a, i, v) => a[i] = v,
_1909: a => a.join(''),
_1910: (o, a, b) => o.replace(a, b),
_1912: (s, t) => s.split(t),
...
_1916: s => s.trimLeft(),
_1917: s => s.trimRight(),
_1919: (s, p, i) => s.indexOf(p, i),
_1920: (s, p, i) => s.lastIndexOf(p, i),
_1922: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
_1923: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
_1924: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
_1925: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
_1926: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
_1927: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
_1928: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
_1930: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
...
_1933: Object.is,
_1934: (t, s) => t.set(s),
_1936: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
_1938: o => o.buffer,
_1939: o => o.byteOffset,
_1940: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
_1941: (b, o) => new DataView(b, o),
_1942: (b, o, l) => new DataView(b, o, l),
_1943: Function.prototype.call.bind(DataView.prototype.getUint8),
_1944: Function.prototype.call.bind(DataView.prototype.setUint8),
_1945: Function.prototype.call.bind(DataView.prototype.getInt8),
_1946: Function.prototype.call.bind(DataView.prototype.setInt8),
_1947: Function.prototype.call.bind(DataView.prototype.getUint16),
_1948: Function.prototype.call.bind(DataView.prototype.setUint16),
_1949: Function.prototype.call.bind(DataView.prototype.getInt16),
_1950: Function.prototype.call.bind(DataView.prototype.setInt16),
_1951: Function.prototype.call.bind(DataView.prototype.getUint32),
_1952: Function.prototype.call.bind(DataView.prototype.setUint32),
_1953: Function.prototype.call.bind(DataView.prototype.getInt32),
_1954: Function.prototype.call.bind(DataView.prototype.setInt32),
_1957: Function.prototype.call.bind(DataView.prototype.getBigInt64),
_1958: Function.prototype.call.bind(DataView.prototype.setBigInt64),
_1959: Function.prototype.call.bind(DataView.prototype.getFloat32),
_1960: Function.prototype.call.bind(DataView.prototype.setFloat32),
_1961: Function.prototype.call.bind(DataView.prototype.getFloat64),
_1962: Function.prototype.call.bind(DataView.prototype.setFloat64),
_1968: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1969: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1971: (s, m) => {
          try {
...
_1976: x0 => x0.pop(),
_1980: (x0,x1,x2) => x0[x1] = x2,
_1982: o => o === undefined,
_1983: o => typeof o === 'boolean',
_1984: o => typeof o === 'number',
_1986: o => typeof o === 'string',
_1989: o => o instanceof Int8Array,
_1990: o => o instanceof Uint8Array,
_1991: o => o instanceof Uint8ClampedArray,
_1992: o => o instanceof Int16Array,
_1993: o => o instanceof Uint16Array,
_1994: o => o instanceof Int32Array,
_1995: o => o instanceof Uint32Array,
_1996: o => o instanceof Float32Array,
_1997: o => o instanceof Float64Array,
_1998: o => o instanceof ArrayBuffer,
_1999: o => o instanceof DataView,
_2000: o => o instanceof Array,
_2001: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_2003: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_2004: o => o instanceof RegExp,
_2005: (l, r) => l === r,
_2006: o => o,
_2007: o => o,
_2008: o => o,
...
_2010: o => o.length,
_2013: (o, i) => o[i],
_2014: f => f.dartFunction,
_2015: l => arrayFromDartList(Int8Array, l),
_2016: l => arrayFromDartList(Uint8Array, l),
_2017: l => arrayFromDartList(Uint8ClampedArray, l),
_2018: l => arrayFromDartList(Int16Array, l),
_2019: l => arrayFromDartList(Uint16Array, l),
_2020: l => arrayFromDartList(Int32Array, l),
_2021: l => arrayFromDartList(Uint32Array, l),
_2022: l => arrayFromDartList(Float32Array, l),
_2023: l => arrayFromDartList(Float64Array, l),
_2024: (data, length) => {
...
_2026: stringFromDartString,
_2027: stringToDartString,
_2028: () => ({}),
_2029: () => [],
_2030: l => new Array(l),
_2031: () => globalThis,
_2032: (constructor, args) => {
...
_2034: (o, p) => o[p],
_2035: (o, p, v) => o[p] = v,
_2036: (o, m, a) => o[m].apply(o, a),
_2038: o => String(o),
_2039: (p, s, f) => p.then(s, f),
_2040: s => {
...
_2057: (o, p) => p in o,
_2064: (x0,x1) => x0.bind(x1),
_2067: x0 => x0.next,
_2074: (x0,x1) => x0.call(x1),
_2075: (x0,x1,x2) => x0.call(x1,x2),
_2085: x0 => x0.done,
_2087: x0 => x0.value,
_2090: () => globalThis.window,
_2111: x0 => x0.matches,
_2115: x0 => x0.platform,
_2120: x0 => x0.navigator,
_2168: (x0,x1) => x0.withCredentials = x1,
_2171: x0 => x0.responseURL,
_2172: x0 => x0.status,
_2173: x0 => x0.statusText,
_2174: (x0,x1) => x0.responseType = x1,
_2176: x0 => x0.response,
_3933: () => globalThis.window,
_3972: x0 => x0.screen,
_3973: x0 => x0.visualViewport,
_4013: x0 => x0.navigator,
_4485: x0 => x0.maxTouchPoints,
_4491: x0 => x0.platform,
_4494: x0 => x0.userAgent,
_8908: () => globalThis.document,
_8993: (x0,x1) => x0.title = x1,
_9010: x0 => x0.hidden,
_10768: x0 => x0.height,
_10806: x0 => x0.height
    };
