...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1707: x0 => globalThis.ZXingWASM.writeBarcode(x0),
      _1708: (x0,x1) => x0.log(x1),
      _1709: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1710: x0 => x0.click(),
      _1711: x0 => x0.remove(),
      _1712: () => globalThis.ZXingWASM.ZXING_WASM_VERSION,
      _1722: x0 => ({locateFile: x0}),
      _1726: x0 => globalThis.ZXingWASM.prepareZXingModule(x0),
      _1727: () => globalThis.ZXingWASM.purgeZXingModule(),
      _1746: x0 => x0.x,
      _1747: x0 => x0.y,
      _1748: x0 => x0.bottomLeft,
      _1749: x0 => x0.bottomRight,
      _1750: x0 => x0.topLeft,
      _1751: x0 => x0.topRight,
      _1752: x0 => x0.bytes,
      _1753: x0 => x0.bytesECI,
      _1754: x0 => x0.contentType,
      _1755: x0 => x0.ecLevel,
      _1756: x0 => x0.error,
      _1757: x0 => x0.format,
      _1758: x0 => x0.hasECI,
      _1759: x0 => x0.isInverted,
      _1760: x0 => x0.isMirrored,
      _1761: x0 => x0.isValid,
      _1762: x0 => x0.lineCount,
      _1763: x0 => x0.orientation,
      _1764: x0 => x0.position,
      _1765: x0 => x0.readerInit,
      _1766: x0 => x0.sequenceId,
      _1767: x0 => x0.sequenceIndex,
      _1768: x0 => x0.sequenceSize,
      _1769: x0 => x0.symbologyIdentifier,
      _1770: x0 => x0.text,
      _1771: x0 => x0.version,
      _1790: (x0,x1) => x0.append(x1),
      _1791: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1791(f,arguments.length,x0,x1) }),
      _1792: (x0,x1) => ({overrides: x0,fireImmediately: x1}),
      _1793: (x0,x1) => x0.log(x1),
      _1794: (x0,x1) => x0.removeChild(x1),
      _1806: x0 => new Array(x0),
      _1808: x0 => x0.length,
      _1810: (x0,x1) => x0[x1],
      _1811: (x0,x1,x2) => x0[x1] = x2,
      _1814: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1816: x0 => new Int8Array(x0),
      _1817: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1818: x0 => new Uint8Array(x0),
      _1826: x0 => new Int32Array(x0),
      _1828: x0 => new Uint32Array(x0),
      _1830: x0 => new Float32Array(x0),
      _1832: x0 => new Float64Array(x0),
      _1833: (o, t) => typeof o === t,
      ...
      _1864: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1865: () => new TextDecoder("utf-8", {fatal: true}),
      _1866: () => new TextDecoder("utf-8", {fatal: false}),
      _1867: x0 => new WeakRef(x0),
      _1868: x0 => x0.deref(),
      _1874: Date.now,
      _1875: secondsSinceEpoch => {
      ...
      _1879: () => typeof dartUseDateNowForTicks !== "undefined",
      _1880: () => 1000 * performance.now(),
      _1881: () => Date.now(),
      _1882: () => {
      ...
      _1884: () => new WeakMap(),
      _1885: (map, o) => map.get(o),
      _1886: (map, o, v) => map.set(o, v),
      _1887: () => globalThis.WeakRef,
      _1898: s => JSON.stringify(s),
      _1899: s => printToConsole(s),
      _1900: a => a.join(''),
      _1901: (o, a, b) => o.replace(a, b),
      _1903: (s, t) => s.split(t),
      _1904: s => s.toLowerCase(),
      _1905: s => s.toUpperCase(),
      _1906: s => s.trim(),
      _1907: s => s.trimLeft(),
      _1908: s => s.trimRight(),
      _1910: (s, p, i) => s.indexOf(p, i),
      _1911: (s, p, i) => s.lastIndexOf(p, i),
      _1912: (s) => s.replace(/\$/g, "$$$$"),
      _1913: Object.is,
      _1914: s => s.toUpperCase(),
      _1915: s => s.toLowerCase(),
      _1916: (a, i) => a.push(i),
      _1920: a => a.pop(),
      _1921: (a, i) => a.splice(i, 1),
      _1923: (a, s) => a.join(s),
      _1924: (a, s, e) => a.slice(s, e),
      _1927: a => a.length,
      _1929: (a, i) => a[i],
      _1930: (a, i, v) => a[i] = v,
      _1932: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1933: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1934: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1935: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      ...
      _1989: o => Object.keys(o),
      _1990: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1991: (handle) => clearTimeout(handle),
      _1992: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1993: (handle) => clearInterval(handle),
      _1994: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1995: () => Date.now(),
      _2020: x0 => x0.getReader(),
      _2024: (x0,x1) => x0.cancel(x1),
      _2025: x0 => x0.read(),
      _2028: x0 => x0.value,
      _2030: x0 => x0.done,
      _2033: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11) => ({method: x0,headers: x1,body: x2,mode: x3,credentials: x4,cache: x5,redirect: x6,referrer: x7,referrerPolicy: x8,integrity: x9,keepalive: x10,signal: x11}),
      _2035: (x0,x1) => x0.method = x1,
      _2048: (x0,x1) => x0.redirect = x1,
      _2061: (x0,x1) => globalThis.fetch(x0,x1),
      _2062: () => new AbortController(),
      _2063: x0 => x0.abort(),
      _2064: (x0,x1) => x0.get(x1),
      _2065: (x0,x1) => x0.get(x1),
      _2066: (x0,x1) => x0.get(x1),
      _2090: x0 => new Headers(x0),
      _2093: x0 => x0.entries(),
      _2112: x0 => x0.body,
      _2114: x0 => x0.headers,
      _2116: x0 => x0.redirected,
      _2117: x0 => x0.status,
      _2118: x0 => x0.statusText,
      _2119: x0 => x0.type,
      _2120: x0 => x0.url,
      _2134: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _2135: (x0,x1,x2) => x0.fetch(x1,x2),
      _2136: (x0,x1) => x0.get(x1),
      _2137: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._2137(f,arguments.length,x0,x1,x2) }),
      _2138: (x0,x1) => x0.forEach(x1),
      _2140: () => new AbortController(),
      _2141: x0 => x0.getReader(),
      _2142: x0 => x0.read(),
      _2150: (x0,x1) => x0.createElement(x1),
      ...
      _2190: (x0,x1) => x0.exec(x1),
      _2191: (x0,x1) => x0.test(x1),
      _2192: (x0,x1) => x0.exec(x1),
      _2193: (x0,x1) => x0.exec(x1),
      _2194: x0 => x0.pop(),
      _2196: o => o === undefined,
      _2215: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _2217: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _2218: o => o instanceof RegExp,
      _2219: (l, r) => l === r,
      _2220: o => o,
      _2221: o => o,
      _2222: o => o,
      ...
      _2224: o => o.length,
      _2227: (o, i) => o[i],
      _2228: f => f.dartFunction,
      _2229: l => arrayFromDartList(Int8Array, l),
      _2230: l => arrayFromDartList(Uint8Array, l),
      _2231: l => arrayFromDartList(Uint8ClampedArray, l),
      _2232: l => arrayFromDartList(Int16Array, l),
      _2233: l => arrayFromDartList(Uint16Array, l),
      _2234: l => arrayFromDartList(Int32Array, l),
      _2235: l => arrayFromDartList(Uint32Array, l),
      _2236: l => arrayFromDartList(Float32Array, l),
      _2237: l => arrayFromDartList(Float64Array, l),
      _2238: x0 => new ArrayBuffer(x0),
      _2239: (data, length) => {
      ...
      _2240: l => arrayFromDartList(Array, l),
      _2241: () => ({}),
      _2242: () => [],
      _2243: l => new Array(l),
      _2244: () => globalThis,
      _2245: (constructor, args) => {
      ...
      _2247: (o, p) => o[p],
      _2248: (o, p, v) => o[p] = v,
      _2249: (o, m, a) => o[m].apply(o, a),
      _2251: o => String(o),
      _2252: (p, s, f) => p.then(s, f),
      _2253: o => {
      ...
      _2254: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _2279: (o, p) => o[p],
      _2280: (o, p, v) => o[p] = v,
      _2285: (x0,x1) => x0.bind(x1),
      _2288: x0 => x0.next,
      _2295: (x0,x1) => x0.call(x1),
      _2296: (x0,x1,x2) => x0.call(x1,x2),
      _2306: x0 => x0.done,
      _2308: x0 => x0.value,
      _2310: x0 => x0.random(),
      _2311: x0 => x0.random(),
      _2312: (x0,x1) => x0.getRandomValues(x1),
      _2313: () => globalThis.crypto,
      _2315: () => globalThis.Math,
      _2317: Function.prototype.call.bind(Number.prototype.toString),
      _2318: (d, digits) => d.toFixed(digits),
      _2322: () => globalThis.document,
      _2346: x0 => x0.src,
      _2347: (x0,x1) => x0.src = x1,
      _2348: x0 => x0.naturalWidth,
      _2349: x0 => x0.naturalHeight,
      _2374: x0 => x0.status,
      _2375: (x0,x1) => x0.responseType = x1,
      _2377: x0 => x0.response,
      _2381: () => globalThis.window.flutterCanvasKit,
      _2382: () => globalThis.window._flutter_skwasmInstance,
      _2905: (x0,x1) => x0.href = x1,
      _3453: (x0,x1) => x0.accept = x1,
      _3467: x0 => x0.files,
      _3493: (x0,x1) => x0.multiple = x1,
      _3511: (x0,x1) => x0.type = x1,
      _3766: (x0,x1) => x0.src = x1,
      _3768: (x0,x1) => x0.type = x1,
      _3972: x0 => x0.width,
      _3973: (x0,x1) => x0.width = x1,
      _3974: x0 => x0.height,
      _3975: (x0,x1) => x0.height = x1,
      _4030: x0 => x0.canvas,
      _4040: (x0,x1) => x0.strokeStyle = x1,
      _4042: (x0,x1) => x0.fillStyle = x1,
      _4054: (x0,x1) => x0.lineWidth = x1,
      _4064: (x0,x1) => x0.font = x1,
      _4066: (x0,x1) => x0.textAlign = x1,
      _4068: (x0,x1) => x0.textBaseline = x1,
      _4229: (x0,x1) => x0.dropEffect = x1,
      _4230: x0 => x0.effectAllowed,
      _4232: x0 => x0.items,
      _4233: x0 => x0.types,
      _4235: (x0,x1) => x0[x1],
      _4239: x0 => x0.length,
      _4243: x0 => x0.kind,
      _4244: x0 => x0.type,
      _4246: x0 => x0.dataTransfer,
      _4250: () => globalThis.window,
      _4315: x0 => x0.navigator,
      _4740: x0 => x0.width,
      _4741: x0 => x0.height,
      _6911: x0 => x0.target,
      _6953: x0 => x0.signal,
      _7032: () => globalThis.document,
      _7122: (x0,x1) => x0.title = x1,
      _7127: x0 => x0.head,
      _7138: x0 => x0.hidden,
      _7832: x0 => x0.pageX,
      _7833: x0 => x0.pageY,
